...
void findExpression(const string& input_str) {
    const int A = input_str[0] - '0';
    const int B = input_str[1] - '0';
    const int C = input_str[2] - '0';
    const int D = input_str[3] - '0';

    for (int op1 = 0; op1 < 2; ++op1) {
        for (int op2 = 0; op2 < 2; ++op2) {
            for (int op3 = 0; op3 < 2; ++op3) {
                int result = A;
                string expression = to_string(A);
