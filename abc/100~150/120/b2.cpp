...
int main()
{
  ...
  問題回答中
    ...
    問題文の理解 read
    解き方探り、考察 plan
      Kのmaxが決まっていないので、割り切れる数を全列挙は無理、数学的な考察が必要
      いや、A,Bを割り切るだから100までの数で全探索すればいいか。      
    コード落とし込み方針決め
    疑問点
      大体、解き方探りとコード落とし込み方針決めで詰まるのでその下にこれを置いておく。
      
      A,B == 100だとして、1000で割るとどっちも割り切れるんじゃ？
      いや、あまり出るから100の全探索でokだね、なぜ分からん？
      つまり限界値100での全探索は成り立たない？
      やってみる。
    実装 do
