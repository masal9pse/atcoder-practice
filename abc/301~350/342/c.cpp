  ...
  復習
    解説記事見たメモ article
      ...
      解説読んで大方理解できるが、落とし込みが面倒な時
        ...
        Sを変えずに「どの文字がどの文字に変わったか？」だけ計算して最後にSを書き換える！」
        コードに落とし込めないね。
    解説動画見たメモ video
    コーナーケース　細かいコーナーケースをここに記載
    参考記事リンク    
    　https://programming-hiroba.com/abc342-c/
    関連キーワード　使用アルゴリズムか考え方等を記載して、コンテスト本番で検索できるようにする
      ex: 全探索
  */  
  // アルファベット26文字を管理するデータ構造を使用
  // クエリで26文字のいずれかに合致したら変換する。
  // このデータ構造は変換後の最後のアルファベット列になる。
  // それを使って、sを変換する。
  int n;
	cin >> n;
	string s;
